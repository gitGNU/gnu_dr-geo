...
#ifndef DRGEO_FLYDRAWABLE_H
#define DRGEO_FLYDRAWABLE_H

#include "drgeo_drawable.h"

/* Implement a flydraw drawable using pstrick package */
class drgeoFlyDrawable:public drgeoDrawable
{
public:
  drgeoFlyDrawable
  ...
  virtual void drawPolygon (drgeoStyle & style, drgeoPoint * point, gint number);
  virtual void drawLine (drgeoStyle & style, drgeoPoint & start, drgeoPoint & end);
  virtual void drawHalfLine (drgeoStyle & style, drgeoPoint & start, drgeoVector & vect);
  virtual void drawSegment (drgeoStyle & style, drgeoPoint & start, drgeoPoint & end);
  virtual void drawCircle (drgeoStyle & style, drgeoPoint & center, double radius);
  virtual void drawCircle (drgeoStyle & style, drgeoPoint & center, drgeoPoint & point);
...
protected:
  drgeoPoint areaToFly (drgeoPoint p);
  /*
