...
#ifndef DRGEO_SEGMENT_H
#define DRGEO_SEGMENT_H

#include "drgeo_direction.h"

class segment:public direction
{
public:
  segment (liste_elem & parents, segmentType type,
	   gboolean createdFromMacro, liste_elem * figureList);
  segment (xmlNodePtr tree, GHashTable * itemIdToAdress,
